...
print("Овчинников Степан ИУ5-51Б")
print("Нахождение корней биквадратного уравнения")
...
if len(sys.argv) == 4:
    ...
    try:
        a = float(input("a = "))
        if a == 0:
            print('Это биквадртаное уравнение, первый коэффициент не может быть 0')
            a = getNumber()
    except ValueError:
...
if a == 0 and b == 0 and c == 0:
    ...
    print('Первый коэффициент не может быть 0')
else:
